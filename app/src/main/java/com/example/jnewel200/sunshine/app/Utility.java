...
public class Utility {
    ...
    public static String getFormattedPressureDisplay(Context context, double pressure){
        //TODO: get the xliff string in the string resources...
        return "PRESSURE: 1000 hPa";
    }
}